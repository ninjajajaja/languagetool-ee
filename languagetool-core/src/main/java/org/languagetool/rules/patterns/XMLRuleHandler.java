...
public class XMLRuleHandler extends DefaultHandler {
  ...
  protected final String PREMIUM = "premium";
  protected final String YES = "yes";
  protected final String OFF = "off";
  protected final String GOAL_SPECIFIC = "is_goal_specific";
  protected final String TRUE = "true";
  protected final String FALSE = "false";
  protected final String TEMP_OFF = "temp_off";
  protected final String ON = "on";
  protected final String POSTAG = "postag";
  protected final String CHUNKTAG = "chunk";
  protected final String CHUNKTAG_REGEXP = "chunk_re";
  protected final String POSTAG_REGEXP = "postag_regexp";
  protected final String REGEXP = "regexp";
  protected final String NEGATE = "negate";
  protected final String INFLECTED = "inflected";
  protected final String NEGATE_POS = "negate_pos";
  protected final String MARKER = "marker";
  protected final String DEFAULT = "default";
  protected final String TYPE = "type";
  protected final String SPACEBEFORE = "spacebefore";
  protected final String EXAMPLE = "example";
  protected final String SCOPE = "scope";
  protected final String IGNORE = "ignore";
  ...
  protected final String UNIFY = "unify";
  protected final String UNIFY_IGNORE = "unify-ignore";
  protected final String AND = "and";
  protected final String OR = "or";
  protected final String EXCEPTION = "exception";
  protected final String CASE_SENSITIVE = "case_sensitive";
  protected final String MARK = "mark";
  protected final String PATTERN = "pattern";
  protected final String ANTIPATTERN = "antipattern";
  protected final String MATCH = "match";
  protected final String UNIFICATION = "unification";
  protected final String RULE = "rule";
  protected final String RULES = "rules";
  protected final String RULEGROUP = "rulegroup";
  protected final String NO = "no";
  protected final String PHRASES = "phrases";
  protected final String MESSAGE = "message";
  protected final String SUGGESTION = "suggestion";
  protected final String TABNAME = "tab";
  protected final String MINPREVMATCHES = "min_prev_matches";
  protected final String DISTANCETOKENS = "distance_tokens";
